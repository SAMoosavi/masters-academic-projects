...
## Properties
- $n$ signers → 1 aggregate signature $\sigma = \sum_{i=1}^n \sigma_i$
...
| Paper | Year | Pairing-Free | Type III | Standard Model | Notable |
|-------|------|:---:|:---:|:---:|---------|
...
| [[tao2026]] | 2026 | ✓ | ✗ | ✗ | ES-CLAS, ≥24.3% reduction, **SOTA** |
...
### By Adversary Type
- **Type I only** (external): cahyadi2022, gong2023, han2022, iqbal2023, tao2026, vallent2021, wang2022, wang2025-ecae, wang2025-detectable, xu2023, yuan2023, zheng2023
- **Type I+II+III** (full): [[wu2025-pseudonyms]], [[wu2025-collusion]], [[yue2025]]

### By Security Model
- **ROM**: 13 papers
- **Standard model**: [[wang2022]], [[yuan2023]]
